...
from keywords.controller import add_keyword, get_favorited_keywords, delete_favorited_keyword

keywords_bp = Blueprint("keywords", __name__)
api = Namespace('keywords', description='Operações relacionadas às palavras-chave favoritas')

keyword_model = api.model('KeywordInput', {
